...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-ltiling_map;-lvisualization;-lonline_coverage_planner".split(';') if "-ltiling_map;-lvisualization;-lonline_coverage_planner" != "" else []
