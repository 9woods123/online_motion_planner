...
//            std::cout<<" v_last: "<<v_last;
//            std::cout<<" min_a_t: "<<min_acc_time;
//            std::cout<<" step: "<<step_distance;
//            std::cout<<" d_acc: "<<distance_acc<<std::endl;
...
//bool Smoother::smooth(const HybridAStar::CollisionDetection *configurationSpace,double d_t, double v_init ,double v_max, double a_max) {
//
//    auto start = std::chrono::high_resolution_clock::now();
//
//    int iterations = 0;
...
//   // =======================  adjust trajectory yaw ==============================
//
//   newPath.back().setT(fourDpath.back().getT());
//
